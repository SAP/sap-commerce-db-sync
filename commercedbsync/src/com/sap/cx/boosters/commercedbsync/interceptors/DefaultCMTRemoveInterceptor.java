...
public class DefaultCMTRemoveInterceptor implements RemoveInterceptor<ItemModel> {
  ...
  private static final boolean deletionsEnabled = Config.getBoolean(CommercedbsyncConstants.MIGRATION_DATA_INCREMENTAL_DELETIONS_ITEMTYPES_ENABLED,false);
  ...
  private  List<String> getListDeletionsItemType() {
    ...
    final String itemTypes = Config.getString(
        CommercedbsyncConstants.MIGRATION_DATA_INCREMENTAL_DELETIONS_ITEMTYPES, "");
